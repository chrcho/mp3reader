...
/**
 * Finder for ID3v1 genre.
 * 
 * @author Chrcho
 */
public class ID3v1GenreFinder {
	 ...
	 */
	public static String find(int genreCode) {
		if (genreCode > 0 && genreCode < GENRES.length) {
	 ...
	 * @return
	 */
	public static boolean check(String searchGenre) {
